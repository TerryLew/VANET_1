...
class BaseWaveApplLayer : public BaseApplLayer {
    ...
    public:
        ...
        static std::ofstream outputFlow;
        static double thpt1;
        static double thpt2;
        static std::map<simtime_t, std::multiset<std::pair<int, std::string> > > hitMap;
        static std::map<int, std::vector<std::pair<std::string, simtime_t> > > reqMap;
